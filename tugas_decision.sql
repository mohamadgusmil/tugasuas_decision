...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 04 Jun 2021 pada 09.13
...
(2, 2, 'L', 14, 'Negeri', 13, 8, 14, 5, 'Sanguin', 1),
(3, 10, 'L', 24, 'Negeri', 19, 16, 2, 3, 'Sanguin', 1);
...
(8, 'Taufik Maulana Hidayat', 'L', 2, 'Swasta', 26),
(9, 'Taufik Maulana Hidayat', 'L', 24, 'Swasta', 27),
(10, 'anju', 'L', 24, 'Negeri', 28);
...
(1, 'Mafaza Al-Aufa', 'L', 13, 'Swasta', 5, 7, 15, 13, 'Melankolis', 'Sanguin', 1),
(2, 'Farhan Syah', 'L', 13, 'Swasta', 8, 13, 8, 11, 'Koleris', 'Sanguin', 1),
(3, 'Hilmi Tajudin', 'L', 15, 'Swasta', 5, 4, 14, 17, 'Plegmatis', 'Sanguin', 1),
(4, 'Firyal Aqillah Tahaani', 'P', 13, 'Swasta', 13, 10, 9, 8, 'Sanguin', 'Sanguin', 1),
(5, 'Abidah Mukhlishoh', 'P', 14, 'Swasta', 7, 3, 13, 17, 'Plegmatis', 'Sanguin', 1),
(6, 'Moch. Yoland Pradana', 'L', 13, 'Negeri', 6, 16, 4, 14, 'Koleris', 'Sanguin', 1),
(7, 'Syifa Arrosyid', 'L', 14, 'Negeri', 18, 7, 8, 7, 'Sanguin', 'Sanguin', 1),
(8, 'Barkatul Mirojiah', 'P', 14, 'Negeri', 13, 9, 7, 11, 'Sanguin', 'Sanguin', 1),
(9, 'Tiara Rossabilla ', 'P', 14, 'Negeri', 6, 6, 10, 18, 'Plegmatis', 'Sanguin', 1),
(10, 'Risma Dewi Septiawati', 'P', 14, 'Negeri', 10, 5, 14, 11, 'Melankolis', 'Sanguin', 1),
(11, 'coba coba', 'L', 14, 'Negeri', 13, 8, 14, 5, 'Sanguin', 'Sanguin', 1),
(12, 'anju', 'L', 24, 'Negeri', 19, 16, 2, 3, 'Sanguin', 'Sanguin', 1);
...
(3, 'Siswa2', 'taufik', '202cb962ac59075b964b07152d234b70', '2'),
(27, 'Taufik Maulana Hidayat', 'taufik', 'd4305d7ed2ec97107cd6eb8dd4b6f6b7', '2'),
(28, 'anju', 'anju', '9abfae448bc00ea3214033a3086e6539', '2');
